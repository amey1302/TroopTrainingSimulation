...
class TrooperTest {
    ...
    void shouldThrowExceptionForInvalidTrainingCost() {
        // assert
        assertThrows(InvalidTroopTrainingTimeAndCostException.class, () -> new Barbarian(3, 0, "sword"));
        assertThrows(InvalidTroopTrainingTimeAndCostException.class, () -> new Barbarian(3, -10, "sword"));
    }

    @Test
    void shouldThrowExceptionForInvalidTrainingTime() {
        // assert
        assertThrows(InvalidTroopTrainingTimeAndCostException.class, () -> new Barbarian(0, 10, "sword"));
        assertThrows(InvalidTroopTrainingTimeAndCostException.class, () -> new Barbarian(-3, 10, "sword"));
    }
